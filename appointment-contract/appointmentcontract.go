...
func (c *Contract) CreatePatient(ctx TransactionContextInterface, userID string, patientID string, memberID string, memberOrganization string, providerID string, providerName string, caregiverID string, caregiverName string, person Person) (*PatientInfo, error) {
	patient := PatientInfo{UserID: userID, PatientID: patientID, MemberID: memberID, MemberOrganization: memberOrganization, ProviderID: providerID, ProviderName: providerName, CaregiverID: caregiverID, CaregiverName: caregiverName, Person: &person}
	//patient.SetIssued()
...
// Update Patient...
func (c *Contract) UpdatePatient(ctx TransactionContextInterface, userID string, patientID string, providerID string, providerName string, caregiverID string, caregiverName string, person Person) (*PatientInfo, error) {
